  ...
  const columns = [
    {
      ...
      label: "Order No.",
      options: {
        customBodyRenderLite: (dataIndex) => <Ellipsis>{orderList[dataIndex]._id}</Ellipsis>,
      },
    },
    {
      name: "customerName",
    ...
    },
    {
      ...
      options: {
        filter: true,
        customBodyRenderLite: (dataIndex) => (
          <Ellipsis>{format(orderList[dataIndex].date, "dd MMM, yyyy")}</Ellipsis>
        ),
      },
    },
    {
    ...
    },
    {
      ...
      options: {
        filter: true,
        customBodyRenderLite: (dataIndex) => <span>${orderList[dataIndex].total.toFixed(2)}</span>,
      },
    },
    {
      name: "action",
